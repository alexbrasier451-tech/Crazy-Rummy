...
export function rulesReference(activeRules = DEFAULT_RULES) {
  ...
  return Object.freeze({
    ...
    sections: Object.freeze([
      ...
      ["Sets, runs, and table additions", "Sets contain three or four cards of one rank; runs contain three or more consecutive cards of one suit. An Ace may be low (A-2-3) or high (Q-K-A), but runs never wrap (K-A-2 is invalid). After opening, a player may add legal cards to any table meld."],
